async function loginCliente() {
    ...
    .then( (dados) => {
        ...
        localStorage.setItem("dadosUsuario", `
                {
                    "nome": "${dados.conteudo[0].nome}",
                    "data_de_nascimento": "${dados.conteudo[0].data_de_nascimento}",
                    "email": "${dados.conteudo[0].email}",
                    "foto": "${dados.conteudo[0].foto}",
                    "cpf": "${dados.conteudo[0].cpf}",
