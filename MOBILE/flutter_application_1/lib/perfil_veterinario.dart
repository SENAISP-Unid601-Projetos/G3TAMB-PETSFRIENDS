...
class PerfilVeterinario extends StatelessWidget {
  const PerfilVeterinario({super.key});
...
class PerfilVetPage extends StatefulWidget {
  @override
  _PerfilVetPageState createState() => _PerfilVetPageState();
}

class _PerfilVetPageState extends State<PerfilVetPage> {
  String nome = "Joelma Aparecida";
  String email = "Jojovet@hotmail.com";
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const AnimaisDisponiveisVet()), // Adicione a tela LoginAdministrador
            );
          },
        ),
      ),
        ...
        child: Column(
          ...
          children: [
            Center(
              child: CircleAvatar(
                radius: 50,
                backgroundImage: AssetImage('assets/images/jojo.webp'),
              ),
            ),
            SizedBox(height: 20),
            ...
            ListTile(
              ...
              onTap: () {Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => AnimaisDisponiveisVet()),
                  );},
            ),
           Divider(),
ListTile(
