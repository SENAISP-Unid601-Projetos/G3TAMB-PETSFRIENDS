...
import 'package:flutter_application_1/login_veterinario.dart'; // Para o uso de imagem de perfil

void main() {
  runApp(const CadastroVeterinario());
}

class CadastroVeterinario extends StatelessWidget {
  const CadastroVeterinario({super.key});
    ...
    return Scaffold(
      ...
      leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => LoginVeterinario()),
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 16),
                    _buildTextField(_crmvController, 'CRMV', Icons.card_membership), // Novo campo CRMV
                    const SizedBox(height: 16),
